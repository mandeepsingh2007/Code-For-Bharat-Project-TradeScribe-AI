...
const Footer = () => {
  return (
    <footer className="bg-dark-300 py-12 relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(128,237,153,0.05)_0%,transparent_70%)]"></div>
      
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            <div className="flex items-center gap-2 mb-6">
              <div className="h-8 w-8 bg-neon rounded-full"></div>
              <span className="text-xl font-bold text-white">TradeScribe<span className="text-neon">AI</span></span>
            </div>
            
            <p className="text-gray-400 mb-6">
              Harness the power of AI to make smarter trading decisions with real-time market analysis and predictive insights.
            </p>
            
            <div className="flex space-x-4">
              <Button variant="ghost" size="icon" className="rounded-full bg-dark-200 hover:bg-neon/20 hover:text-neon">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li><a href="#insights" className="hover:text-neon transition-colors">AI Insights</a></li>
              <li><a href="#performance" className="hover:text-neon transition-colors">Performance</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li><a href="#" className="hover:text-neon transition-colors">Risk Disclosure</a></li>
              <li><a href="#" className="hover:text-neon transition-colors">Security</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} TradeScribeAI. All rights reserved.
            </p>
